...
public abstract class TransactionArgument {
    ...
    public static TransactionArgument deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            default: throw new com.GRTeamA.novi.serde.DeserializationError("Unknown variant index for TransactionArgument: " + index);
        }
    }
    ...
    public static TransactionArgument bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class U8 extends TransactionArgument {
        ...
        public U8(@com.GRTeamA.novi.serde.Unsigned Byte value) {
        ...
        static U8 load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
    ...
    public static final class U64 extends TransactionArgument {
        public final @com.GRTeamA.novi.serde.Unsigned Long value;

        public U64(@com.GRTeamA.novi.serde.Unsigned Long value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static U64 load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
        ...
        public static final class Builder {
            public @com.GRTeamA.novi.serde.Unsigned Long value;
    ...
    public static final class U128 extends TransactionArgument {
        public final java.math.@com.GRTeamA.novi.serde.Unsigned @com.GRTeamA.novi.serde.Int128 BigInteger value;

        public U128(java.math.@com.GRTeamA.novi.serde.Unsigned @com.GRTeamA.novi.serde.Int128 BigInteger value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static U128 load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
        ...
        public static final class Builder {
            public java.math.@com.GRTeamA.novi.serde.Unsigned @com.GRTeamA.novi.serde.Int128 BigInteger value;
    ...
    public static final class Address extends TransactionArgument {
        ...
        static Address load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
    ...
    public static final class U8Vector extends TransactionArgument {
        ...
        public U8Vector(com.GRTeamA.novi.serde.Bytes value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static U8Vector load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
    ...
    public static final class Bool extends TransactionArgument {
        ...
        static Bool load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
