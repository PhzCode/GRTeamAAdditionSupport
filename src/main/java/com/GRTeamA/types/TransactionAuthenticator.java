...
public abstract class TransactionAuthenticator {
    ...
    public static TransactionAuthenticator deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
        int index = deserializer.deserialize_variant_index();
        switch (index) {
            case 0: return Ed25519.load(deserializer);
            default: throw new com.GRTeamA.novi.serde.DeserializationError("Unknown variant index for TransactionAuthenticator: " + index);
        }
    }
    ...
    public static TransactionAuthenticator bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Ed25519 extends TransactionAuthenticator {
        ...
        static Ed25519 load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
