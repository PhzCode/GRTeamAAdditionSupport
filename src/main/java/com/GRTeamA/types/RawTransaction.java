...
public final class RawTransaction {
    ...
    public final @com.GRTeamA.novi.serde.Unsigned Long sequence_number;
    public final TransactionPayload payload;
    public final @com.GRTeamA.novi.serde.Unsigned Long max_gas_amount;
    public final @com.GRTeamA.novi.serde.Unsigned Long gas_unit_price;
    public final String gas_currency_code;
    public final @com.GRTeamA.novi.serde.Unsigned Long expiration_timestamp_secs;
    public final ChainId chain_id;

    public RawTransaction(AccountAddress sender, @com.GRTeamA.novi.serde.Unsigned Long sequence_number, TransactionPayload payload, @com.GRTeamA.novi.serde.Unsigned Long max_gas_amount, @com.GRTeamA.novi.serde.Unsigned Long gas_unit_price, String gas_currency_code, @com.GRTeamA.novi.serde.Unsigned Long expiration_timestamp_secs, ChainId chain_id) {
    ...
    public static RawTransaction deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
    ...
    public static RawTransaction bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Builder {
        ...
        public @com.GRTeamA.novi.serde.Unsigned Long sequence_number;
        public TransactionPayload payload;
        public @com.GRTeamA.novi.serde.Unsigned Long max_gas_amount;
        public @com.GRTeamA.novi.serde.Unsigned Long gas_unit_price;
        public String gas_currency_code;
        public @com.GRTeamA.novi.serde.Unsigned Long expiration_timestamp_secs;
