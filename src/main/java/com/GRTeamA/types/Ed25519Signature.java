...
public final class Ed25519Signature {
    ...
    public Ed25519Signature(com.GRTeamA.novi.serde.Bytes value) {
    ...
    public static Ed25519Signature deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
    ...
    public static Ed25519Signature bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
