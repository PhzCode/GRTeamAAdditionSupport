...
public abstract class TypeTag {
    ...
    public static TypeTag deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            default: throw new com.GRTeamA.novi.serde.DeserializationError("Unknown variant index for TypeTag: " + index);
        }
    }
    ...
    public static TypeTag bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Signer extends TypeTag {
        ...
        static Signer load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            deserializer.decrease_container_depth();
            return builder.build();
    ...
    public static final class Vector extends TypeTag {
        ...
        static Vector load(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
