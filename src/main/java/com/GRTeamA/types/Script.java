...
public final class Script {
    public final com.GRTeamA.novi.serde.Bytes code;
    public final java.util.List<TypeTag> ty_args;
    public final java.util.List<TransactionArgument> args;

    public Script(com.GRTeamA.novi.serde.Bytes code, java.util.List<TypeTag> ty_args, java.util.List<TransactionArgument> args) {
    ...
    public static Script deserialize(com.GRTeamA.novi.serde.Deserializer deserializer) throws com.GRTeamA.novi.serde.DeserializationError {
    ...
    public static Script bcsDeserialize(byte[] input) throws com.GRTeamA.novi.serde.DeserializationError {
        if (input == null) {
    ...
    public static final class Builder {
        public com.GRTeamA.novi.serde.Bytes code;
