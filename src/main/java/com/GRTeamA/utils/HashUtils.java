...
import com.GRTeamA.types.RawTransaction;
import com.GRTeamA.types.SignedTransaction;
import com.GRTeamA.types.Transaction;
...
public class HashUtils {
    ...
    public static byte[] hashPrefix(String name) {
        return hash("::".getBytes(), name.getBytes());
    }
